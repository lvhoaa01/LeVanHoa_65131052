...
public class Cau1Fragment extends Fragment {
    ...
    private TextInputEditText cau1Val;
    private Button cau1Btn;
    private TextView cau1Res;
    public Cau1Fragment() {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        cau1Btn = view.findViewById(R.id.cau1_btn);
        cau1Val = view.findViewById(R.id.cau1_val);
        cau1Res = view.findViewById(R.id.cau1_res);

        cau1Btn.setOnClickListener(v -> {
            try {
                double val = Double.parseDouble(cau1Val.getEditableText().toString());
                double res = val * 26000;
                cau1Res.setText(String.valueOf(res));
            } catch (Exception e) {
